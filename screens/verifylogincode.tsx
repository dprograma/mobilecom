...
type VerifyLoginCodeScreenProps = {
  navigation: StackNavigationProp<any>;
};

const VerifyLoginCodeScreen: React.FC<VerifyLoginCodeScreenProps> = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.welcometextln2}>email address</Text>
        ...
        titleStyle={styles.signInButtonText} onPress={() => navigation.navigate('Dashboard')} />
...
export default VerifyLoginCodeScreen;
